...
with open("LinearRegModel","wb") as file:
...
with open("TreeModel","wb") as file:
...
with open("RandForeModel","wb") as file:
    pickle.dump(rnd_search,file)
...
with open("GridModel","wb") as file:
